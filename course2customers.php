                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Assgin Course to Customers</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="assign_course_to_customers-<?php echo $rownum['courseid'] ?>" class="btn btn-primary waves-effect waves-light">Assign to Customers</a>
                                        </div>
                                    </div>
