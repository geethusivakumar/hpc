                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Customers assigned to different Courses</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-bod table-responsive">
                                        <?php
                                        $query="select userdetails.name,userdetails.photo,courses.course_name,user_courses.joined_date,user_courses.status as coursestatus,admin_details.name as adminname from userdetails,courses,user_courses,admin_details,userlogin where courses.courseid=user_courses.course_id && user_courses.user_id=userlogin.user_id && user_courses.user_id=userdetails.user_id && userdetails.user_id=userlogin.user_id && userlogin.role='customer' && userdetails.created_by=user_courses.created_by && user_courses.created_by=admin_details.user_id order by userdetails.name";
