            ...
            <div class="main-content">
                ...
                <div class="page-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="results-<?php echo $rownum['courseid'] ?>" class="btn btn-primary waves-effect waves-light">Quiz Results</a>
                    ...
                    <div class="alert alert-warning alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                            <i class="mdi mdi-alert-outline label-icon"></i><strong>Warning</strong> Quiz results are shown only if users attend the quiz..!!
                                        </div>
                                    </div>
