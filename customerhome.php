                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php 
                         ...
                         $mycourses=mysqli_query($conn01,"select courses.* from courses,user_courses,userlogin where courses.courseid=user_courses.course_id && userlogin.user_id=user_courses.user_id && userlogin.role='customer' && userlogin.status='Active' && userlogin.username='".$_SESSION['username']."'");
                         $mycoursesdetails=mysqli_num_rows($mycourses);
                         $completedcourses=mysqli_query($conn01,"select courses.* from courses,user_courses,userlogin where courses.courseid=user_courses.course_id && userlogin.user_id=user_courses.user_id && userlogin.role='customer' && userlogin.status='Active' && user_courses.status='completed' && userlogin.username='".$_SESSION['username']."'");
