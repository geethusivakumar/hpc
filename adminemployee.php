                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <button type="button" class="btn btn-danger w-lg waves-effect waves-light add_btn" data-bs-toggle="modal" data-bs-target="#AddAdmin" >Add Employee</button>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form  method="POST" class="w-100" enctype="multipart/form-data">
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="name" placeholder="Enter Employee Name" id="example-text-input" required>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea id="basicpill-address-input" name="address" class="form-control" rows="2" placeholder="Enter Employee's Address"></textarea>
                                                                </div>
                                                            </div>
                                             ...
                                             <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="qualifn" placeholder="Enter Employee's Qualification" id="example-text-input" required>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="phone" placeholder="Enter Employee's Contact Number" id="example-text-input" required>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="email" name="emailid" placeholder="Enter Employee's Email ID" id="example-text-input" required>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="text" name="username" placeholder="Enter Employee's Username" id="example-text-input" required>
                                                    </div>
                                ...
                                <div class="modal-footer ">
                                    <button type="submit" name="addemployee" id="addadmin_btn"class="btn btn-success ">Add</button>
                                ...
                                <!--########################### ADD OUTPUT########################### -->
                                    ...
                                    <div class="card-bod table-responsive">
                                        ...
                                        $row2=mysqli_fetch_array($sel2);
                                          $query_run="select userdetails.*,userlogin.* from userdetails,userlogin where userdetails.user_id=userlogin.user_id && userdetails.created_by=".$row2['user_id']." && userlogin.role='employee'";
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                            ...
                                            <button class="btn btn-success waves-effect waves-light edit_btn" data-bs-toggle="modal" data-bs-target="#EmployeeEdit<?php echo $rownum['user_id']; ?>">
                                            <i class="mdi mdi-pencil  font-size-18 align-middle me-2"></i>Edit</button>
                                            
                                            </div>
                                            <!-- The Modal -->
                                                <div class="modal" id="EmployeeEdit<?php echo $rownum['user_id']; ?>">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="example-text-input" class="form-label">Name</label>
                                                        <input class="form-control" type="text" name="name" value="<?php echo $rownum['name']; ?>" placeholder="Enter Employee Name" id="example-text-input">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    <label for="basicpill-address-input" class="form-label">Address</label>
                                                                    <textarea id="basicpill-address-input" name="address" class="form-control" rows="2" placeholder="Enter Employee's Address"><?php echo $rownum['address']; ?></textarea>
                                                                </div>
                                                            </div>
                                             ...
                                             <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        <label for="example-text-input" class="form-label">Qualification</label>
                                                        <input class="form-control" type="text" name="qualifn" value="<?php echo $rownum['qualifn']; ?>"  placeholder="Enter Employee's Qualification" id="example-text-input">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        <label for="example-text-input" class="form-label">Contact Number</label>
                                                        <input class="form-control" type="text" name="phone" value="<?php echo $rownum['phone']; ?>"   placeholder="Enter Employee's Contact Number" id="example-text-input">
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div>
                                                    <div class="mb-3">
                                                        <label for="example-text-input" class="form-label">Email ID</label>
                                                        <input class="form-control" type="text" name="emailid" value="<?php echo $rownum['emailid']; ?>"   placeholder="Enter Employee's Email ID" id="example-text-input">
                                                    </div>
                                            ...
                                            <div class="mb-3">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <p class="help-block" style="color:#900;">*Only jpg, jpeg, and png files are allowed*<br/>Resolution - (250px*250px)</p>
                                                                    <img src='Employees/<?php echo $rownum['photo'] ?>' style="width:50px; height:50px;" id='userimg'/>
                                                                            <script>
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer ">
                                                            <button type="submit" name="editemployee<?php echo $rownum['user_id']; ?>" id="addadmin_btn"class="btn btn-success ">Update</button>
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                        </div>
                                                        </form>
                                                    </div>
                                            ...
                                            <?php
                                        if(isset($_POST['editemployee'.$rownum['user_id']]))
                                        {
                                            $name=$_POST['name'];
                                            $gender=$_POST['gender'];
                                        ...
                                        ?>
                                            ...
                                            <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#EmployeeDelete<?php echo $rownum['user_id']; ?>">
                                            <i class="mdi mdi-trash-can  font-size-18 align-middle me-2"></i> Delete
                                            </button></div>
                                        
                                        <!-- The Modal -->
                                        <div class="modal" id="EmployeeDelete<?php echo $rownum['user_id']; ?>">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <p><div class="alert alert-warning">Are you sure you want to delete this Employee?</p>
                                                        </div>
