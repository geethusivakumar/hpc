                                ...
                                <table id="datatable" class="table table-bordered nowrap w-100">
                                            ...
                                            <tbody>
                                               ...
                                               if(mysqli_num_rows($sql_query_run) > 0)
                                               {
                                                   ...
                                                   {
                                                    $name=mysqli_query($conn01,"select userdetails.*,userlogin.role from userdetails,userlogin where userdetails.user_id=userlogin.user_id && userlogin.user_id=".$rownum['userid']);
