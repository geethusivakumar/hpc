...
$sel2=mysqli_query($conn01,"select userlogin.user_id,userdetails.name from userlogin,userdetails where userlogin.user_id=userdetails.user_id && userlogin.username='".$_SESSION['username']."'");
                ...
                if(isset($_POST['generatecert']))
                {
                    ...
                    if(mysqli_num_rows($certfict)>0)
                    {
                        echo "<script>alert('Certificate generated already, Please check your certificates on Certificates section..!!');
                                document.location='customercertificates';
                                </script>";
                    }
                    else{
                    ...
                    $certificate_pdf=$join_id.".pdf";
                            ...
                            else
                            {
                                ...
                                document.location='customerertificates';
                                </script>";
