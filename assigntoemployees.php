                ...
                <div class="page-content">
                    ...
                    <?php
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Assign Employees in to <?php echo $coursedetails['course_name']?></h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php
                                        $sel2=mysqli_query($conn01,"select user_id  from userlogin where username='".$_SESSION['username']."'");
                                        $row2=mysqli_fetch_array($sel2);
                                          $query_run="select userdetails.*,userlogin.* from userdetails,userlogin where userdetails.user_id=userlogin.user_id && userdetails.created_by=".$row2['user_id']." && userlogin.role='employee' && userlogin.status='Active'";
                                  ...
                                  <tr>
                                    <th scope="col" style="width: 50px;">
                                        <div class="form-check font-size-16">
                                            <input type="checkbox" name="allemployees" class="form-check-input" value="checkall" id="checkAll">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="Employees/<?php echo $rownum['photo']?>" alt="" class="avatar-sm rounded-circle me-2">
                        ...
                        <div class="row pt-3">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Total Employees assigned to <?php echo $coursedetails['course_name']?></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="table-responsive mb-4">
                                <?php
                                          $query="select userdetails.*,userlogin.* from userdetails,userlogin where userdetails.user_id=userlogin.user_id && userdetails.created_by=".$row2['user_id']." && userlogin.role='employee' && userlogin.status='Active'";
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="d-flex flex-wrap">
                                            <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#DeleteEmployee<?php echo $r['join_id']; ?>" title="Delete <?php echo $row['name']; ?> from <?php echo $coursedetails['course_name']?>">
                                            <i class="mdi mdi-trash-can  font-size-18 align-middle me-2"></i> Delete
                                            </button></div>
                                        
                                        <!-- The Modal -->
                                        <div class="modal" id="DeleteEmployee<?php echo $r['join_id']; ?>">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">

                                                        <!-- Modal Header -->
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Delete Employee from Course</h4>
                                                        ...
                                                        <p><div class="alert alert-warning">Are you sure want to delete this employee from <?php echo $coursedetails['course_name']?>?</p>
                                                        </div>
                                                        ...
                                                        <input type="hidden" name="h1" value="<?php echo $r['join_id']?>"/>
                                                            <button type="submit" name="deleteemployee<?php echo $r['join_id']; ?>" id="addadmin_btn" class="btn btn-success ">Yes</button>
                                            ...
                                            <?php
                                                if(isset($_POST['deleteemployee'.$r['join_id']]))
                                                {
                                                    $join_id =$_POST['h1'];
                                        $del=mysqli_query($conn01,"delete from user_courses where join_id =".$join_id ."");
                                            if($del)
                                                    {
                                                        echo "<script>
                                                                document.location='assign_course_to_employees-".$_GET['courseid']."';					
                                                              </script>";
...
if(isset($_POST['assignnow']))
			{
				...
				{
					echo "<script>
					alert('Employees not available for this course');
					document.location='assign_course_to_employees-".$_GET['courseid']."';
					</script>";
				}
            }
