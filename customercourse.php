...
include 'includes/__cuscoursenavbar.php';
                                    ...
                                    <?php
                                        ...
                                        else if((@$_GET['chap_details']=='notes')&&(@$_GET['chap_id']!=""))
                                        {
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <!-- <object data="pdf/<?php //echo $chapdetails['pdfpath'];?>" type="application/pdf" style="width: 100%; height: 800px; display: block;"></object> -->
                                                </object>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        else if((@$_GET['chap_details']=='quiz')&&(@$_GET['chap_id']!=""))
                                        {
                                            ...
                                            <form method="post" action="cuzsubmitquiz.php">
                                            <?php
